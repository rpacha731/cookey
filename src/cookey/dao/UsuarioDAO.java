...
public class UsuarioDAO implements IUsuarioDAO<UsuarioDTO> {
	...
	public static final String SQL_READ_USER_2 = "SELECT * FROM usuarios WHERE nombre_usuario = ?";
	...
	@Override
	public UsuarioDTO readU(String nomUser) {
		...
		try {
			...
			ResultSet rs = null;
			PreparedStatement ps = con.getCnn().prepareCall(SQL_READ_USER_2);
	...
	@Override
	public boolean deleteU(Object DNI, Object Actividad) {
	...
	@Override
	public boolean updateU(UsuarioDTO e) {
	...
	// Este no le veo mucha utilidad xd
	@Override
	public List<UsuarioDTO> readAllU() {
